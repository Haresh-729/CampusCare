...
const DynamicCard = ({ tabs, activeTab, onTabChange, content }) => {
    return (
        <div className="relative bg-white rounded-lg shadow-lg w-full mx-auto my-6 p-6">
            ...
            {/* Close Button */}
            <button className="hidden absolute top-4 right-4 text-red bg-white h-4 text-2xl font-bold">&times;</button>
